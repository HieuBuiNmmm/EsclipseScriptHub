...
description: >
  ...
  caveats. Engine layer only — language rules live in luau-expert; Rojo/Wally
...
- **Don't conflate engine and language.** If the question is about typing or `--!strict` behavior, defer to `luau-expert`. If it's about Rojo or filesystem layout, defer to `roblox-toolchain`.
